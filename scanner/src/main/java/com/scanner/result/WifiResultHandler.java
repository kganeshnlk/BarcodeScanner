...
import com.scanner.ScanListener;
import com.scanner.ScannerActivity;
import com.scanner.wifi.WifiConfigManager;
...
public final class WifiResultHandler extends ResultHandler {
    ...
    public WifiResultHandler(ScannerActivity activity, ParsedResult result, ScanListener listener) {
        super(activity, result);
        context = activity;
        this.listener = listener;
    }

    public WifiResultHandler(CaptureActivity activity, ParsedResult result, ScanListener listener) {
        super(activity, result);
        context = activity;
        this.listener = listener;
    }
    ...
    public void handleButtonPress(int index) {
        if (index == 0) {
            ...
            if (listener != null) listener.restartPreviewAfterDelay(0L);
        }
    }
